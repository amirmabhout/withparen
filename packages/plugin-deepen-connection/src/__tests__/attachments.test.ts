...
describe('processAttachments', () => {
  ...
  <text>This image captures a breathtaking sunset scene over a calm ocean. The sky is painted with brilliant hues of orange, pink, and purple as the sun dips below the horizon. Gentle waves lap at the shore, creating a peaceful and deepen-connectione atmosphere.</text>
</response>`);
    ...
    expect(result[0].text).toBe(
      'This image captures a breathtaking sunset scene over a calm ocean. The sky is painted with brilliant hues of orange, pink, and purple as the sun dips below the horizon. Gentle waves lap at the shore, creating a peaceful and deepen-connectione atmosphere.'
    );
