...
// import * as evaluators from './evaluators/index.ts'; // Removed - plugin-memory handles evaluators
...
export const discoverConnectionPlugin: Plugin = {
  ...
  evaluators: [], // Removed reflectionEvaluator - plugin-memory handles dimension extraction
  providers: [
    providers.userStatusProvider,
    providers.matchStateProvider,
    // Removed connectionMemoryProvider and personaMemoryProvider - plugin-memory handles this
