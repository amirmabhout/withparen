...
This plugin provides actions and providers for interacting with Circles protocol and EVM-compatible chains.

## Description

The Circles plugin provides streamlined functionality for interacting with EVM-compatible chains, focusing on token transfers, swaps, and trust operations for the Circles ecosystem.
...
```bash
bun add @elizaos/plugin-circles
```
